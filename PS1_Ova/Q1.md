...
Ubuntu 12.04 LTS
![lightdm](/VirtualBox_saic_05_01_2024_10_12_36.png)

Finding more info and most importantly ip address and open ports.
![ip](/VirtualBox_saic_05_01_2024_10_23_31.png)
...
![80](/Screenshot%20from%202024-01-11%2014-47-55.png)
...
![mysql](/VirtualBox_saic_05_01_2024_10_26_07.png)

```5.5.54``` might be the version of it. idk, will see later.

Confirmed.
![mysql_ver](/Screenshot%20from%202024-01-05%2010-50-55.png)

Now since I have the Ip, lets nmap and find something else if I can.
![nmap](/Screenshot%20from%202024-01-05%2010-57-13.png)
```Apache 2.2.22```
...
![options](/Screenshot%20from%202024-01-05%2011-20-16.png)

Missed checking the php version earlier, here it is.
![php](/Screenshot%20from%202024-01-05%2012-00-24.png)
...
![whatcaniaccess](/VirtualBox_saic_11_01_2024_14_51_54.png)

Found all website content. Clearly I can see that theres something more than what I got in ```robots.txt```.

Found this : 

![secret](/VirtualBox_saic_05_01_2024_15_07_17.png)
...
![backup](/Screenshot%20from%202024-01-11%2015-04-07.png)

So, this is what I was supposed to do with that username.

![sms](/Screenshot%20from%202024-01-11%2015-06-25.png)
...
![database](/VirtualBox_saic_05_01_2024_15_22_17.png)

Logging in : 

![login](/VirtualBox_saic_11_01_2024_18_57_08.png)
...
![revmd5](/Screenshot%20from%202024-01-11%2019-12-37.png)
...
![video](/Screenshot%20from%202024-01-11%2019-18-39.png)

It took me to DINA 1.0.1

![dina](/Screenshot%20from%202024-01-11%2019-20-42.png)
